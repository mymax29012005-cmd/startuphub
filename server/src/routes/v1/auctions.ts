...
auctionsRouter.post("/:auctionId/bids", requireAuth, requireNotDeleted, requireNotBanned, requireVerifiedEmail, async (req, res) => {
  const prisma = getPrisma();
  const auctionId =
    typeof req.params.auctionId === "string" ? req.params.auctionId : req.params.auctionId[0];
...
auctionsRouter.post("/:auctionId/join", requireAuth, requireNotDeleted, requireNotBanned, requireVerifiedEmail, async (req, res) => {
  const prisma = getPrisma();
  const auctionId =
    typeof req.params.auctionId === "string" ? req.params.auctionId : req.params.auctionId[0];
  try {
...
auctionsRouter.post("/:auctionId/leave", requireAuth, requireNotDeleted, requireNotBanned, requireVerifiedEmail, async (req, res) => {
  const prisma = getPrisma();
  const auctionId =
    typeof req.params.auctionId === "string" ? req.params.auctionId : req.params.auctionId[0];
  try {
