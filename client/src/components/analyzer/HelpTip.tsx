...
export function HelpTip({
  ...
  return (
    <span className="relative group inline-flex items-center ml-2">
      ...
      <span
        className="pointer-events-none absolute left-1/2 top-7 z-20 w-[260px] -translate-x-1/2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-150"
      >
