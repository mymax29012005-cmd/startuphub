  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <Card className="p-6 md:p-10">
        <h1 className="text-2xl font-semibold text-white">Редактировать запрос инвестиций</h1>
        ...
        {loading ? (
          ...
          >
            ...
            <label>
              <div className="text-xs text-[rgba(234,240,255,0.72)] mb-1">Статус</div>
              <select
                className="focus-ring [color-scheme:dark] text-white w-full rounded-2xl border border-[rgba(255,255,255,0.14)] bg-white/5 px-4 py-2 text-sm"
                value={status}
            ...
            <div>
              ...
              <div className="mt-1 text-[10px] text-[rgba(234,240,255,0.55)]">
                Что за проект, на что нужны деньги, условия.
              </div>
            </div>
