  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div className="mb-5 flex items-center justify-between gap-4">
        <Link href={`/startups/${id}`} className="text-[var(--accent)] hover:text-white text-sm font-medium">
          ← Назад
        </Link>
      </div>

      <Card className="p-6 md:p-10">
        <h1 className="text-2xl font-semibold text-white">Редактировать стартап</h1>
          ...
          >
            <div>
              ...
              <div className="mt-1 text-[10px] text-[rgba(234,240,255,0.55)]">
                Коротко и понятно: что за проект и для кого.
              </div>
            </div>
            ...
            <div>
              <Input
                ...
                inputMode="numeric"
              />
              <div className="mt-1 text-[10px] text-[rgba(234,240,255,0.55)]">Целое число, без копеек.</div>
            </div>
            ...
            <div>
              ...
              />
              <div className="mt-1 text-[10px] text-[rgba(234,240,255,0.55)]">
                Что делаете, для кого, чем лучше, текущий статус и что продаёте.
              </div>
            </div>
            ...
            <div className="glass rounded-3xl p-4 border border-[rgba(255,255,255,0.12)]">
              ...
              <div className="mt-2 text-xs text-[rgba(234,240,255,0.72)]">
                Можно добавлять/убирать вложения (презентации, PDF и т.д.).
              </div>
